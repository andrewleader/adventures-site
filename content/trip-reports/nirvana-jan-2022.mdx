...
- Singles #0.3-4A #5 or double #4 could have been useful for P1, but you only use cams for P1 (plus one #3 on P2). Was a little runout without, but was okay, I used every cam including moving 2 cams up.

8 draws (no doubles)1 webbing in case needed for Juniper tree rappel (existing webbing was okay)70m rope- The 70 was worth it so could rappel P3-2 as one! 60m would have to rappel those individually

Didn't bring- Nuts (not useful)
